...
public class MyLegStep {
    ...
    private MyStepManeuver maneuver;
    private double weight;
    private List<MyStepIntersection> intersections = new ArrayList<MyStepIntersection>();
    ...
    public MyLegStep(LegStep step) {
        this.distance = step.getDistance();
        this.duration = step.getDuration();
        this.geometry = step.getGeometry();
        this.name = step.getName();
        this.ref = step.getRef();
        this.destinations = step.getDestinations();
        this.mode = step.getMode();
        this.pronunciation = step.getPronunciation();
        this.rotaryName = step.getRotaryName();
        this.rotaryPronunciation = step.getRotaryPronunciation();
        this.maneuver = new MyStepManeuver(step.getManeuver());
        this.weight = step.getWeight();
        for (int i = 0; i < step.getIntersections().size(); i++) {
            this.intersections.add(new MyStepIntersection(step.getIntersections().get(i)));
        }
    }
     ...
     * @since 1.0.0
     */
    public MyStepManeuver getManeuver() {
        return maneuver;
    }
     ...
     * @since 2.1.0
     */
    public void setManeuver(MyStepManeuver maneuver) {
     ...
     * @since 1.3.0
     */
    public List<MyStepIntersection> getIntersections() {
     ...
     * @since 2.1.0
     */
    public void setIntersections(List<MyStepIntersection> intersections) {
